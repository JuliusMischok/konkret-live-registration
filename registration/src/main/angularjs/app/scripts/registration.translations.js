...
var app = angular.module('registration')
	.config(['$translateProvider', function($translateProvider) {
		$translateProvider.translations('de', {
			...
			TEXT_SUCCESS:							'<h1>Anmeldung abgeschlossen!</h1>Deine Anmeldedaten wurden gespeichert. Falls du Rückfragen hast oder innerhalb der nächsten 10 Minuten keine Bestätitgungmail erhältst, wende dich bitte an <a href="mailto:office@konkretlive.de">office@konkretlive.de</a>, hier kannst du auch Teilnehmer nach- oder abmelden.',
